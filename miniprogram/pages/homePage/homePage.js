    ...
    timerAnimationInit(){
      ...
      timerAnimationStart() {
        let iconUrl = this.data.cancelColletIconTwo
         this.data.animation.scale(2.0).step({ duration: 700, timingFunction: 'ease' }).scale(1.0).step({ duration: 300, timingFunction: 'ease' })
         this.setData({
      ...
      // 结束动画
      aniEnd(){
        this.data.animation.scale(1.0).step({ duration: 700, timingFunction: 'ease' })
        this.setData({
          ani: this.data.animation.export()
      })
      },
